<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="activitiesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="活动日期" align="center" prop="date" width="180">
...
<script>
import { listActivities, getActivities, delActivities, addActivities, updateActivities } from "@/api/activities/activities";
