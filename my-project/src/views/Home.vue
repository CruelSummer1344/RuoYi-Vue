    ...
    <div class="home">
        ...
        <div class="top-nav">
            <div class="welcome-text">
                <i class="el-icon-location"></i> 欢迎来到东营旅游门户网站
            </div>
...
<!--              <el-avatar :size="30" :src="userInfo.avatar || '/assets/default-avatar.png'"></el-avatar>-->
...
<!--            </div>-->
        ...
        <div class="search-container">
            <div class="search-wrapper">
                <div class="logo">
                    <img src="../assets/logo/dy1.jpg" alt="Logo" class="logo-image" />
                    <h1>东营旅游</h1>
                </div>
                <el-input
                    v-model="searchQuery"
...
<!--                <el-menu-item index="attractions">景点门票</el-menu-item>-->
<!--                <el-menu-item index="routes">精品路线</el-menu-item>-->
<!--                <el-menu-item index="hotels">酒店住宿</el-menu-item>-->
<!--                <el-menu-item index="food">美食推荐</el-menu-item>-->
<!--                <el-menu-item index="culture">文化体验</el-menu-item>-->
<!--                <el-menu-item index="guide">旅游攻略</el-menu-item>-->
<!--                <el-menu-item index="about">关于东营</el-menu-item>-->
<!--            </el-menu>-->
        </div>

        <!-- 轮播图 -->
        <div class="carousel-container">
            <el-carousel height="450px" class="carousel" indicator-position="outside" arrow="always">
                <el-carousel-item v-for="item in carouselItems" :key="item.id">
                    <div class="carousel-content">
                        ...
                        <div class="carousel-caption">
                            ...
                            <el-button type="primary" round @click="viewDetail(item)">查看详情</el-button>
                        </div>
                    </div>
                </el-carousel-item>
            </el-carousel>
        ...
        <el-row :gutter="20" class="content-row">
                    ...
                    >
                        <el-table-column width="60">
                            <template slot-scope="scope">
                                <div class="rank-number" :class="{'top-three': scope.row.rank <= 3}">
                                    {{ scope.row.rank }}
                                </div>
                            </template>
                        </el-table-column>
                    ...
                    <div class="weather-content">
                        ...
                        <div class="weather-details">
                            ...
                            <div class="weather-detail-item">
                                ...
                                <span class="value" :class="'air-quality-' + weatherInfo.airQualityLevel">
            ...
            <el-col :span="12">
                        ...
                        >
                            <div class="travel-card-content">
                                <div class="travel-card-image">
                                    ...
                                    <div class="travel-card-tag" v-if="item.tag">{{ item.tag }}</div>
                                </div>
                ...
                <div class="attractions-recommend">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8" v-for="(item, index) in attractionsList" :key="index">
                    ...
                    <el-timeline>
                        ...
                        >
                            <div class="news-item" @click="viewNewsDetail(item)">
                                ...
                                <div class="news-meta" v-if="item.views || item.comments">
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <div class="social-media">
                        <a href="#"><i class="el-icon-s-custom"></i> 微信公众号</a>
                        <a href="#"><i class="el-icon-s-promotion"></i> 微博</a>
                        <a href="#"><i class="el-icon-mobile"></i> 小程序</a>
                        <a href="#"><i class="el-icon-phone"></i> 客服热线</a>
                    </div>
                </div>
            </div>
